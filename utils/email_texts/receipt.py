...
<div class="receipt">
    <div class="header">
        <div class="title">
            <svg style="width: 30px; height: 30px;" viewBox="0 0 512 512" fill="#00cd00">
            ...
            <span>Безопасная оплата с Bitcoin</span>
        </div>
        <div class="logo">
            <img src="https://skycrypto.net/logo-white.png" alt="SKY"/>
            <div class="caption">SKY PAY</div>
        </div>
        <div class="sky-pay-link">
            <a href="https://skycrypto.net" target="_blank">skycrypto.net</a>
        </div>
    </div>

    <div class="content">
        <svg style="width: 80px; height: 80px; margin-left: 45%;" viewBox="0 0 594 594" fill="#00cd00">
        ...
        <div class="payment-success">ОПЛАТА ПРОШЛА УСПЕШНО</div>

        <div style="margin-top: 30px;"><b>ИНФОРМАЦИЯ О СДЕЛКЕ В SKY PAY:</b></div>
        <div class="info-row" style="margin-top: 10px;">
            <span class="label">Вы отдали:</span><span class="value">{paid} RUB</span>
        </div>
        <div class="info-row">
            <span class="label">Вы получили:</span><span class="value">{received} {symbol}</span>
        </div>
        <div class="info-row">
        ...
        <div class="info-row">
            <span class="label">SKY ID сделки:</span><span class="value">{deal_id}</span>
        </div>
        <div class="info-row">
            <span class="label">Статус:</span>
            <div class="stamp">УСПЕШНО</div>
        </div>

        <div style="margin-top: 30px;"><b>ИНФОРМАЦИЯ О ЗАКАЗЕ:</b></div>
        <div class="info-row" style="margin-top: 10px;">
            <span class="label">Заказ в:</span>
            <div class="merchant">
                <img src="{url}" alt=""/>
        ...
        <div class="info-row">
            <span class="label">Номер заказа:</span><span class="value">{label}</span>
        </div>
        <div class="info-row">
            <span class="label">Время оплаты:</span><span class="value">{closed_at}</span>
        </div>
        <div class="info-row">
            <span class="label">Статус:</span>
